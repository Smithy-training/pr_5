            ...
            Form(
              ...
              child: Column(
                children: [
                  TextFormField(
                    decoration:
                    InputDecoration(labelText: 'Название', filled: true, fillColor: Colors.grey[700],),
                  ...
                  TextFormField(
                    decoration:
                    InputDecoration(labelText: 'URL изображения', filled: true, fillColor: Colors.grey[700],),
                    style: TextStyle(color: Colors.white),
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                  ...
                  TextFormField(
                    decoration:
                    InputDecoration(labelText: 'Цена', filled: true, fillColor: Colors.grey[700],),
                    style: TextStyle(color: Colors.white),
                  ...
                  TextFormField(
                    decoration:
                    InputDecoration(labelText: 'Описание', filled: true, fillColor: Colors.grey[700],),
                    style: TextStyle(color: Colors.white),
                    maxLines: 3,
                    onSaved: (value) {
                      _description = value ?? '';
